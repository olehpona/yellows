package com.github.olehpona.yellows.core.plugins.builtin.logic;
...
@Plugin(id="builtin.logic.gte")
public class Gte implements PluginNode {
    @Override
    public void execute(PluginReadWrapper input, PluginCallback cb) {
        ...
        returnValue.putPath("out", a.gte(b));
