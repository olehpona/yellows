...
public class GraphBuilderTest {
    ...
    void testDuplicateNodeNames(){
        ...
        GraphException exception = assertThrows(GraphException.class, () -> GraphBuilder.buildGraph(List.of(a, a1), Map.of()));
    ...
    void testSimpleLoop(){
        ...
        GraphException exception = assertThrows(GraphException.class, () -> GraphBuilder.buildGraph(List.of(a, b, c), Map.of()));
    ...
    void testDisconnectedLoop() {
        ...
        GraphException exception = assertThrows(GraphException.class, () -> GraphBuilder.buildGraph(List.of(a, b, d, e), Map.of()));
    ...
    void testWriteWriteExactKeyConflict(){
        ...
        GraphException exception = assertThrows(GraphException.class, () -> GraphBuilder.buildGraph(List.of(a, b, c,d), Map.of()));
    ...
    void testIndependentRootsIsolation() {
        ...
        GraphException exception = assertThrows(GraphException.class, () ->
                GraphBuilder.buildGraph(List.of(a1, b1, c1, a2, b2, c2), Map.of(), 4, false));
